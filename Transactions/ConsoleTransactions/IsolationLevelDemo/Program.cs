...
//the following code comes from https://msdn.microsoft.com/en-us/library/system.data.isolationlevel(v=vs.110).aspx

namespace IsolationLevelDemo
{
    ...
    class Program
    {
        ...
        {
            string connString = @"Data Source=.\SQLEXPRESS;Initial Catalog=master;Integrated Security=True;Asynchronous Processing=true;";
